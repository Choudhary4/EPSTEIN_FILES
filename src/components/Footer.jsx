        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-12 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="https://github.com/Choudhary4/EPSTEIN_FILES" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-white transition-colors flex items-center gap-2">
                ...
                <li>
                  <a href="https://instagram.com/kuntal_16_2_8" target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-pink-500 transition-colors flex items-center gap-2">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
